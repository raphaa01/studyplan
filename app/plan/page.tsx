...
export default function PlanPage() {
  ...
  return <>
    ...
    <div className="plan-toolbar-row">
      ...
      <span className={`planner-engine-status is-${plannerStatus}`} title={plannerReason ?? undefined} aria-live="polite"><BrainCircuit size={14} />{plannerStatus === "loading" ? "QECore v1.09 plant lokal" : plannerStatus === "ready" ? "Geplant mit QECore v1.09" : plannerStatus === "fallback" ? "Sicherer Basisplan" : "Lokale Planung"}</span>
    </div>
